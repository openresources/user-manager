    ...
    <div class="container mx-auto rounded p-4 mt-2 overflow-y-auto relative">
        <div class="bg-white rounded px-8 py-8" @click.away="{{$modalVariable}} = false">
            ...
            <div class="modal-body">
                <form action="{{ route('user-manager.bulk.imports.index') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="flex flex-col w-full items-center justify-center bg-gray-100 py-16">
                        <p class="text-lg leading-loose text-center">Create multiple user accounts by uploading an excel file. <br> Download a <a class="underline" href="{{ route('user-manager.bulk.samples.index') }}">sample excel
                        ...
                        <label
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" class="h-10 w-10 fill-current">
                                <path
                            ...
                            <input type='file' name="user_list" class="appearance-none mt-2 italic lowercase text-sm text-gray-200 hover:text-white leading-normal" />
                        </label>
